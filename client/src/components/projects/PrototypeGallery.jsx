    ...
    <div className="group relative flex flex-col overflow-hidden rounded-lg border bg-card text-card-foreground shadow-sm transition-shadow hover:shadow-md">
      ...
      <div className="flex flex-1 flex-col gap-2 p-3">
        <div className="flex items-start justify-between gap-2">
          <h4 className="line-clamp-2 text-sm font-semibold leading-snug">{prototype.title}</h4>
        ...
        {prototype.description && (
          <p className="line-clamp-2 text-xs text-muted-foreground">{prototype.description}</p>
        )}
    ...
    <div className="rounded-xl border border-primary/20 bg-primary/5 p-4 mb-4">
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        <div className="space-y-1">
          <Label htmlFor="proto-title" className="text-xs">
            Title *
          </Label>
          <Input
            id="proto-title"
        ...
        {mode === 'file' ? (
          <div className="space-y-1">
            <Label htmlFor="proto-file" className="text-xs">
              ...
              <span className="text-muted-foreground">
                (Image / Video — max {MAX_FILE_SIZE_MB} MB)
              </span>
            </Label>
            <Input
              id="proto-file"
          ...
          <div className="space-y-1">
            <Label htmlFor="proto-url" className="text-xs">
              URL *
            </Label>
            <Input
              id="proto-url"
  ...
  return (
    <Card>
      ...
      <CardContent>
        {/* Inline add panel */}
        {showAddPanel && (
          <AddPrototypePanel projectId={projectId} onClose={() => setShowAddPanel(false)} />
        )}
