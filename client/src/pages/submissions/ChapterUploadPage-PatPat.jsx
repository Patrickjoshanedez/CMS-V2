    ...
    <DashboardLayout>
      <div className="mx-auto max-w-2xl space-y-6">
        ...
        <Alert>
          <AlertTriangle className="h-4 w-4" />
          <AlertDescription>
            You can upload any chapter at any time. Re-uploading the same chapter is only allowed
            after adviser revision request.
          </AlertDescription>
        </Alert>
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  {CHAPTER_LABELS.map((label, idx) => {
                    ...
                    return (
                      <option key={chapterValue} value={chapterValue}>
                        {label}
                      </option>
                    );
                  })}
