  ...
  return (
    <div ref={ref} className="reports-dropdown" id={id}>
      ...
      <button
        ...
        onClick={() => setOpen((p) => !p)}
      >
        <span className="reports-dropdown-trigger-text">{value ? selectedLabel : placeholder}</span>
      ...
      {open && (
        <div className="reports-dropdown-popover">
          ...
          <div className="reports-dropdown-list">
            ...
            {filtered.length === 0 && <p className="reports-dropdown-empty">No results found</p>}
          </div>
        </div>
      )}
    </div>
        ...
        {!isLoading && !error && hasResults && (
          <div className="reports-kpi-grid">
            {[
              {
                icon: BarChart3,
                label: 'Total Capstones Archived',
                value: summary.totalCapstonesArchived,
                accent: 'blue',
              },
              {
                icon: CalendarRange,
                label: 'Most Active Year',
                value: summary.mostActiveYear || 'N/A',
                accent: 'emerald',
              },
              {
                icon: Users,
                label: 'Total Authors / Students',
                value: summary.totalAuthorsStudents,
                accent: 'violet',
              },
              {
                icon: ShieldAlert,
                label: 'Plagiarism-Flagged',
                value: summary.flaggedByPlagiarism,
                accent: 'rose',
              },
            ].map((kpi) => (
