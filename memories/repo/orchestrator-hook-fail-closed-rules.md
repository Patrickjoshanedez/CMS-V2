...
- On Windows hook runners, avoid hard-coding `.venv/Scripts/python.exe`; use `py -3` in hook config so cleanup of local virtualenv does not break pretool/posttool hooks.
